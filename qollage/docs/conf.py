...
Typst_elements = {
    ...
    #
    # 'pointsize': '10pt',
    # Additional stuff for the Typst preamble.
    #
    # 'preamble': '',
    # Typst figure (float) alignment
    #
    # 'figure_align': 'htbp',
}

# Grouping the document tree into Typst files. List of tuples
...
man_pages = [(master_doc, "qoqopyquest", "qoqo Typst Documentation", [author], 1)]
